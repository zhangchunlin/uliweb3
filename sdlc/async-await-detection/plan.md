...
- [ ] **1. feat(SimpleFrame)：settings 加载处挂 debug 期 warnings 过滤**
...
- [ ] **2. docs(zh_CN) + `Request.get_*` docstring/类型标注**
...
- [ ] **3. 终检**：仓库根 `nosetests --with-doc test` 全绿（OK）；`git status` 工作区干净；2 处改动落位。
