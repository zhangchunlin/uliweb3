...
**重要更新**：本模块已从 WSGI 迁移到 ASGI。详细信息请参考 [ASGI 迁移设计文档](../../intent/asgi-migration/spec.md)。
...
**参考文档**: [ASGI 迁移设计文档](../../intent/asgi-migration/spec.md)
...
- [ASGI 迁移设计文档](../../intent/asgi-migration/spec.md): ASGI 迁移指南
